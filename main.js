...
let secretCodePieces = ['Wherefore','2023','tastes','fathom','redolent','virtue','unbeknownst','against','prescient','antediluvians','begetting','tides?'];
...
{
    name: 'Contains the name of a Zodiac sign',
    rank: 2,
...
},
{
    ...
    rank: 3,
    exp: '^john|paul|george|ringo|pete.*$',
    cased:false,
    active:true,
    requires:[]
},
...
{
    name: 'Ends with whether you take the unlabeled box: yes or no?',
    rank: 7,
    exp: "^.*yes|no$",
    cased: false,
    active: true,
...
{
    name: 'Ends with whether you take the mirror shard: yes or no?',
    rank: 7,
    exp: "^.*yes|no$",
    cased: false,
    active: true,
...
// BACK TO A
{
    ...
    rank: 8,
    exp: "morning|evening|noon|dawn|dusk|midday|night|afternoon|suppertime|breakfast|brunch|((1[0-2]|0?[1-9])((:[0-5][0-9])|[ap]m|(:[0-5][0-9])[ap]m))",
    cased: false,
    active: true,
    requires: [],
    timeline: 'a'
...
{
    name: 'Begins with how many miles per hour over the speed limit you\'re driving',
    rank: 8,
    exp: "^[1-9].*$",
    cased: false,
    active: true,
...
{
    name: 'Ends with the highway number where the sirens start',
    rank: 8,
    //exp: "[i](nterstate)?[-]?[1-9]",
    exp:'^.*[1-9]$',
    cased: false,
...
{
    name: 'Begins with the number of minutes until the officer sees the stolen box',
    rank: 9,
    exp: "^[1-9].*$",
    cased: false,
    active: true,
...
{
    name: 'Begins with the number of minutes until the officer sees the bloody mirror',
    rank: 9,
    exp: "^[1-9].*$",
    cased: false,
    active: true,
...
{
    name: 'Begins with the beats per minute of your racing heart',
    rank: 9,
    exp: "^[1-9][0-9]{1,2}.*$",
    cased: false,
    active: true,
...
{
    name: 'Contains the angle (in degrees) the shard hits flesh',
    rank: 10,
    exp: "[1-9]",
    cased: false,
    active: true,
...
{
    name: 'Begins with the color of the lake',
    rank: 10,
...
{
    name: 'Contains its greatest attribute: a mirror or a depth?',
    rank: 10,
    exp: "mirror|depth",
    cased: false,
    active: true,
...
{
    name: 'Contains the height (in feet) of the boxy store beyond the lot',
    rank: 10,
    exp: "[1-9][0-9]",
    cased: false,
    active: true,
    requires: ['leaveArtifact','visitStore'],
    timeline: 'ceg'
},
{
...
{
    name: 'Ends with a decision to go inside: yes or no?',
    rank: 10,
    exp: "^.*yes|no$",
    cased: false,
    active: true,
...
// Look into the box
{
    name: 'Begins with the number of seconds it takes to snap the latch',
    rank: 11,
    exp: "^[1-9].*$",
    cased: false,
    active: true,
...
{
    name: 'Enter the date (MM/DD/YYYY) the first stars burn out. It\'s sooner than you think.',
    rank: 12,
    exp: '(0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])[\/\-][0-9]{4}',
    cased: false,
    active: true,
    requires: ['takeArtifact','viewArtifact','surrenderPolice','pickWheel'],
    timeline: 'ceg'
...
{
    name: 'Begins with the number of seconds it takes to raise the mirror',
    rank: 11,
    exp:"^[1-9].*$",
    cased: false,
    active: true,
...
},
{
    ...
    rank: 11,
    exp:"left|right|behind|ahead|beside|north|south|east|west",
    cased: false,
    active: true,
    requires: ['takeArtifact','rejectArtifact','pickMirrors','surrenderPolice'],
    timeline: 'ceg'
...
{
    name: 'Begins with the seat the box rolls into',
    rank: 11,
...
{
    name: 'Begins with the time you stop to help the officer',
    rank: 11,
    exp:"^(1[0-2]|0?[1-9])((:[0-5][0-9])|[ap]m|(:[0-5][0-9])[ap]m).*$",
    cased: false,
    active: true,
...
{
    name: function() {
        return 'Enter the hand that the ' + gameAttributes.womanDress + '-clad woman uses to take the mirror. She smiles at you as she wipes the blood off with her dress.'
   },
    rank: 12,
...
{
    name: 'Begins with the miles you drive with the mirror beside you',
    rank: 11,
    exp:"^[1-9].*$",
    cased: false,
    active: true,
    requires: ['takeArtifact','resistPolice','pickMirrors','keepDriving'],
    timeline: 'ceg'
},
{
...
// Look into the lake
{
    name: 'Begins with the hours you stare into the lake',
    rank: 11,
    exp:"^[1-9].*$",
    cased: false,
    active: true,
...
// Wade into the lake
{
    name: 'Begins with the time you drop into the lake',
    rank: 11,
    exp:"^(1[0-2]|0?[1-9])((:[0-5][0-9])|[ap]m|(:[0-5][0-9])[ap]m).*$",
    cased: false,
    active: true,
...
},
{
    ...
    rank: 11,
    exp:"^.*up|down|left|right|north|south|east|west$",
    cased: false,
    active: true,
    requires: ['leaveArtifact','visitLake','goInside'],
    timeline: 'ceg'
...
// Enter the store
{
    name: 'Begins with the number of fingers on the associate who greets you',
    rank: 11,
    exp:"^[0-9]{1,2}.*$",
    cased: false,
    active: true,
...
{
    name: 'Begins with the degrees fahrenheit of your car\'s pleather seats',
    rank: 11,
    exp:"^[1-9][0-9].*$",
    cased: false,
    active: true,
    requires: ['leaveArtifact','visitStore','stayOutside'],
    timeline: 'ceg'
},
{
...
{
    name: 'Enter the state with the best traveling carnival. Because that\'s where you are when you wake up.',
    rank: 12,
    exp: "alabama|alaska|arizona|arkansas|california|colorado|connecticut|delaware|florida|georgia|hawaii||hawai\'i|idaho|illinois|indiana|iowa|kansas|kentucky|louisiana|maine|maryland|massachusetts|michigan|minnesota|mississippi|missouri|montana|nebraska|nevada|newhampshire|newjersey|newmexico|newyork|northcarolina|northdakota|ohio|oklahoma|oregon|pennsylvania|rhodeisland|southcarolina|southdakota|tennessee|texas|utah|vermont|virginia|washington|westvirginia|wisconsin|wyoming",
    cased: false,
    active: true,
...
const submitPassword = (password) => {
    ...
    let cleanPassword = filterSlurs(password);
    document.getElementById('password-results').innerHTML = cleanPassword;
    finalPassword += cleanPassword;
    console.log('Cleaned password: ' + cleanPassword);
    console.log('Final password: ' + finalPassword);
    // Systems for choice branching
    password = password.toLowerCase();
    console.log('Password for choices: ' + password);
    if (question === 1){
        let pass = 0;
        for (let i = 0; i < secretCodePieces.length; i++){
            let regex = new RegExp(secretCodePieces[i].toLowerCase());
            if (regex.test(password) === true){
                pass++;
            };
            console.log(pass + ':' + regex);
        };
        if (pass === secretCodePieces.length){
            enteredSecretCode();
        ...
        } else if (gameState.visitStore === true){
            if (/yes/.test(password) === true){
                gameState.goInside = true;
                pruneBranch = 'stayOutside';
                ...
                console.log('Error on inside/outside store.');
            };
        };
    ...
    if (pruneBranch !== ''){
        ...
        console.log('Branch pruned: ' + pruneBranch);
        pruneBranch = '';
    };
    console.log('Branch pruned: ' + pruneBranch);
    console.log('Choices: ' + finalChoices.join(','));
    for (let i = 0; i < ruleStory.length; i++){
        console.log(ruleStory[i].name + ruleStory[i].active);
    };
...
let slurList = ['[cCĆćĈĉČčĊċÇçḈḉȻȼꞒꞓꟄꞔƇƈɕ][hĤĥȞȟḦḧḢḣḨḩḤḥḪḫH̱ẖĦħⱧⱨꞪɦꞕΗНн][iIÍíi̇́Ììi̇̀ĬĭÎîǏǐÏïḮḯĨĩi̇̃ĮįĮ́į̇́Į̃į̇̃ĪīĪ̀ī̀ỈỉȈȉI̋i̋ȊȋỊịꞼꞽḬḭƗɨᶖİiIıＩｉ1lĺľļḷḹl̃ḽḻłŀƚꝉⱡɫɬꞎꬷꬸꬹᶅɭȴＬｌ][NnŃńǸǹŇňÑñṄṅŅņṆṇṊṋṈṉN̈n̈ƝɲŊŋꞐꞑꞤꞥᵰᶇɳȵꬻꬼИиПпＮｎ][KkḰḱǨǩĶķḲḳḴḵƘƙⱩⱪᶄꝀꝁꝂꝃꝄꝅꞢꞣ][SsŚśṤṥŜŝŠšṦṧṠṡŞşṢṣṨṩȘșS̩s̩ꞨꞩⱾȿꟅʂᶊᵴ]?','[cCĆćĈĉČčĊċÇçḈḉȻȼꞒꞓꟄꞔƇƈɕ][oOÓóÒòŎŏÔôỐốỒồỖỗỔổǑǒÖöȪȫŐőÕõṌṍṎṏȬȭȮȯO͘o͘ȰȱØøǾǿǪǫǬǭŌōṒṓṐṑỎỏȌȍȎȏƠơỚớỜờỠỡỞởỢợỌọỘộO̩o̩Ò̩ò̩Ó̩ó̩ƟɵꝊꝋꝌꝍⱺＯｏ0]{2}[nNŃńǸǹŇňÑñṄṅŅņṆṇṊṋṈṉN̈n̈ƝɲŊŋꞐꞑꞤꞥᵰᶇɳȵꬻꬼИиПпＮｎ][sSŚśṤṥŜŝŠšṦṧṠṡŞşṢṣṨṩȘșS̩s̩ꞨꞩⱾȿꟅʂᶊᵴ]?','[FfḞḟƑƒꞘꞙᵮᶂ][AaÁáÀàĂăẮắẰằẴẵẲẳÂâẤấẦầẪẫẨẩǍǎÅåǺǻÄäǞǟÃãȦȧǠǡĄąĄ́ą́Ą̃ą̃ĀāĀ̀ā̀ẢảȀȁA̋a̋ȂȃẠạẶặẬậḀḁȺⱥꞺꞻᶏẚＡａ@4][GgǴǵĞğĜĝǦǧĠġG̃g̃ĢģḠḡǤǥꞠꞡƓɠᶃꬶＧｇqꝖꝗꝘꝙɋʠ]{1,2}([OoÓóÒòŎŏÔôỐốỒồỖỗỔổǑǒÖöȪȫŐőÕõṌṍṎṏȬȭȮȯO͘o͘ȰȱØøǾǿǪǫǬǭŌōṒṓṐṑỎỏȌȍȎȏƠơỚớỜờỠỡỞởỢợỌọỘộO̩o̩Ò̩ò̩Ó̩ó̩ƟɵꝊꝋꝌꝍⱺＯｏ0e3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅiÍíi̇́Ììi̇̀ĬĭÎîǏǐÏïḮḯĨĩi̇̃ĮįĮ́į̇́Į̃į̇̃ĪīĪ̀ī̀ỈỉȈȉI̋i̋ȊȋỊịꞼꞽḬḭƗɨᶖİiIıＩｉ1lĺľļḷḹl̃ḽḻłŀƚꝉⱡɫɬꞎꬷꬸꬹᶅɭȴＬｌ][TtŤťṪṫŢţṬṭȚțṰṱṮṯŦŧȾⱦƬƭƮʈT̈ẗᵵƫȶ]{1,2}([RrŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ][YyÝýỲỳŶŷY̊ẙŸÿỸỹẎẏȲȳỶỷỴỵɎɏƳƴỾỿ]|[RrŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ][IiÍíi̇́Ììi̇̀ĬĭÎîǏǐÏïḮḯĨĩi̇̃ĮįĮ́į̇́Į̃į̇̃ĪīĪ̀ī̀ỈỉȈȉI̋i̋ȊȋỊịꞼꞽḬḭƗɨᶖİiIıＩｉ1lĺľļḷḹl̃ḽḻłŀƚꝉⱡɫɬꞎꬷꬸꬹᶅɭȴＬｌ][Ee3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅ])?)?[SsŚśṤṥŜŝŠšṦṧṠṡŞşṢṣṨṩȘșS̩s̩ꞨꞩⱾȿꟅʂᶊᵴ]?','[KkḰḱǨǩĶķḲḳḴḵƘƙⱩⱪᶄꝀꝁꝂꝃꝄꝅꞢꞣ][iIÍíi̇́Ììi̇̀ĬĭÎîǏǐÏïḮḯĨĩi̇̃ĮįĮ́į̇́Į̃į̇̃ĪīĪ̀ī̀ỈỉȈȉI̋i̋ȊȋỊịꞼꞽḬḭƗɨᶖİiIıＩｉ1lĺľļḷḹl̃ḽḻłŀƚꝉⱡɫɬꞎꬷꬸꬹᶅɭȴＬｌyÝýỲỳŶŷY̊ẙŸÿỸỹẎẏȲȳỶỷỴỵɎɏƳƴỾỿ][KkḰḱǨǩĶķḲḳḴḵƘƙⱩⱪᶄꝀꝁꝂꝃꝄꝅꞢꞣ][Ee3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅ]([RrŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ][YyÝýỲỳŶŷY̊ẙŸÿỸỹẎẏȲȳỶỷỴỵɎɏƳƴỾỿ]|[rRŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ][IiÍíi̇́Ììi̇̀ĬĭÎîǏǐÏïḮḯĨĩi̇̃ĮįĮ́į̇́Į̃į̇̃ĪīĪ̀ī̀ỈỉȈȉI̋i̋ȊȋỊịꞼꞽḬḭƗɨᶖİiIıＩｉ1lĺľļḷḹl̃ḽḻłŀƚꝉⱡɫɬꞎꬷꬸꬹᶅɭȴＬｌ][Ee3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅ])?[SsŚśṤṥŜŝŠšṦṧṠṡŞşṢṣṨṩȘșS̩s̩ꞨꞩⱾȿꟅʂᶊᵴ]*','([SsŚśṤṥŜŝŠšṦṧṠṡŞşṢṣṨṩȘșS̩s̩ꞨꞩⱾȿꟅʂᶊᵴ][Aa4ÁáÀàĂăẮắẰằẴẵẲẳÂâẤấẦầẪẫẨẩǍǎÅåǺǻÄäǞǟÃãȦȧǠǡĄąĄ́ą́Ą̃ą̃ĀāĀ̀ā̀ẢảȀȁA̋a̋ȂȃẠạẶặẬậḀḁȺⱥꞺꞻᶏẚＡａ][NnŃńǸǹŇňÑñṄṅŅņṆṇṊṋṈṉN̈n̈ƝɲŊŋꞐꞑꞤꞥᵰᶇɳȵꬻꬼИиПпＮｎ][DdĎďḊḋḐḑD̦d̦ḌḍḒḓḎḏĐđÐðƉɖƊɗᵭᶁᶑȡ])?[NnŃńǸǹŇňÑñṄṅŅņṆṇṊṋṈṉN̈n̈ƝɲŊŋꞐꞑꞤꞥᵰᶇɳȵꬻꬼИиПпＮｎ][IiÍíi̇́Ììi̇̀ĬĭÎîǏǐÏïḮḯĨĩi̇̃ĮįĮ́į̇́Į̃į̇̃ĪīĪ̀ī̀ỈỉȈȉI̋i̋ȊȋỊịꞼꞽḬḭƗɨᶖİiIıＩｉ1lĺľļḷḹl̃ḽḻłŀƚꝉⱡɫɬꞎꬷꬸꬹᶅɭȴＬｌoÓóÒòŎŏÔôỐốỒồỖỗỔổǑǒÖöȪȫŐőÕõṌṍṎṏȬȭȮȯO͘o͘ȰȱØøǾǿǪǫǬǭŌōṒṓṐṑỎỏȌȍȎȏƠơỚớỜờỠỡỞởỢợỌọỘộO̩o̩Ò̩ò̩Ó̩ó̩ƟɵꝊꝋꝌꝍⱺＯｏІіa4ÁáÀàĂăẮắẰằẴẵẲẳÂâẤấẦầẪẫẨẩǍǎÅåǺǻÄäǞǟÃãȦȧǠǡĄąĄ́ą́Ą̃ą̃ĀāĀ̀ā̀ẢảȀȁA̋a̋ȂȃẠạẶặẬậḀḁȺⱥꞺꞻᶏẚＡａ][GgǴǵĞğĜĝǦǧĠġG̃g̃ĢģḠḡǤǥꞠꞡƓɠᶃꬶＧｇqꝖꝗꝘꝙɋʠ]{1,2}(l[Ee3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅ]t|[Ee3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅaÁáÀàĂăẮắẰằẴẵẲẳÂâẤấẦầẪẫẨẩǍǎÅåǺǻÄäǞǟÃãȦȧǠǡĄąĄ́ą́Ą̃ą̃ĀāĀ̀ā̀ẢảȀȁA̋a̋ȂȃẠạẶặẬậḀḁȺⱥꞺꞻᶏẚＡａ][RrŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ]?|n[ÓóÒòŎŏÔôỐốỒồỖỗỔổǑǒÖöȪȫŐőÕõṌṍṎṏȬȭȮȯO͘o͘ȰȱØøǾǿǪǫǬǭŌōṒṓṐṑỎỏȌȍȎȏƠơỚớỜờỠỡỞởỢợỌọỘộO̩o̩Ò̩ò̩Ó̩ó̩ƟɵꝊꝋꝌꝍⱺＯｏ0][gGǴǵĞğĜĝǦǧĠġG̃g̃ĢģḠḡǤǥꞠꞡƓɠᶃꬶＧｇqꝖꝗꝘꝙɋʠ]|[aA4ÁáÀàĂăẮắẰằẴẵẲẳÂâẤấẦầẪẫẨẩǍǎÅåǺǻÄäǞǟÃãȦȧǠǡĄąĄ́ą́Ą̃ą̃ĀāĀ̀ā̀ẢảȀȁA̋a̋ȂȃẠạẶặẬậḀḁȺⱥꞺꞻᶏẚＡａ]?)?[sSŚśṤṥŜŝŠšṦṧṠṡŞşṢṣṨṩȘșS̩s̩ꞨꞩⱾȿꟅʂᶊᵴ]?','[tTŤťṪṫŢţṬṭȚțṰṱṮṯŦŧȾⱦƬƭƮʈT̈ẗᵵƫȶ][rRŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ][aAÁáÀàĂăẮắẰằẴẵẲẳÂâẤấẦầẪẫẨẩǍǎÅåǺǻÄäǞǟÃãȦȧǠǡĄąĄ́ą́Ą̃ą̃ĀāĀ̀ā̀ẢảȀȁA̋a̋ȂȃẠạẶặẬậḀḁȺⱥꞺꞻᶏẚＡａ4]+[NnŃńǸǹŇňÑñṄṅŅņṆṇṊṋṈṉN̈n̈ƝɲŊŋꞐꞑꞤꞥᵰᶇɳȵꬻꬼИиПпＮｎ]{1,2}([IiÍíi̇́Ììi̇̀ĬĭÎîǏǐÏïḮḯĨĩi̇̃ĮįĮ́į̇́Į̃į̇̃ĪīĪ̀ī̀ỈỉȈȉI̋i̋ȊȋỊịꞼꞽḬḭƗɨᶖİiIıＩｉ1lĺľļḷḹl̃ḽḻłŀƚꝉⱡɫɬꞎꬷꬸꬹᶅɭȴＬｌ][eE3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅ]|[YyÝýỲỳŶŷY̊ẙŸÿỸỹẎẏȲȳỶỷỴỵɎɏƳƴỾỿ]|[Ee3ЄєЕеÉéÈèĔĕÊêẾếỀềỄễỂểÊ̄ê̄Ê̌ê̌ĚěËëẼẽĖėĖ́ė́Ė̃ė̃ȨȩḜḝĘęĘ́ę́Ę̃ę̃ĒēḖḗḔḕẺẻȄȅE̋e̋ȆȇẸẹỆệḘḙḚḛɆɇE̩e̩È̩è̩É̩é̩ᶒⱸꬴꬳＥｅ][RrŔŕŘřṘṙŖŗȐȑȒȓṚṛṜṝṞṟR̃r̃ɌɍꞦꞧⱤɽᵲᶉꭉ])[sSŚśṤṥŜŝŠšṦṧṠṡŞşṢṣṨṩȘșS̩s̩ꞨꞩⱾȿꟅʂᶊᵴ]?'];

const filterSlurs = (password) => {
    //let cleaned;
    let dirty = password;
    let clean;
    let regex;
    for (let i = 0; i < slurList.length; i++){
        regex = new RegExp(slurList[i]);
        clean = dirty.replace(regex,'');
        console.log ('Removed: ' + regex);
        dirty = clean;
    };
    return clean;
};
...
const endGame = () => {
    ...
    let index = (element) => element === finalCodeFragment;
    let finalFragmentNumber = (secretCodePieces.findIndex(index) + 1);
...
const restartGame = () => {
    ...
    document.getElementById('game-choices').textContent = '';
};
